...
const AboutComponent = () => {
  return (
    <div className='flex p-4  py-10 lg:p-10 justify-center'>

       
        <div className=" space-y-20 bg-pink-50 p-10">


        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
<AboutContainer title='Mission 🚀:'className='bg-green-100'>
   <p className='text-lg'>
...
students and educators, ensuring academic excellence and success.</p>
   ...
   <AboutContainer title='Platform Overview 🌐:'className='bg-rose-100'>
   <p className='text-lg'>
...
<AboutContainer title='Key Features 🌟:'className='bg-blue-100'>
   ...
   <AboutContainer title='Vision 🔮:'className='bg-zinc-100 '>
   <p className='text-lg  '>
